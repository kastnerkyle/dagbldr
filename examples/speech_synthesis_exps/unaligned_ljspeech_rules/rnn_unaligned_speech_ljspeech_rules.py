...
filedir = "/Tmp/kastner/lj_speech_rule_speakers/norm_info/"
...
filedir = "/Tmp/kastner/lj_speech_rule_speakers/numpy_features/"
if not os.path.exists(filedir):
    if filedir[-1] != "/":
        fd = filedir + "/"
    else:
...
checkpoint_dict = create_checkpoint_dict(locals(), magic_reload=True)
